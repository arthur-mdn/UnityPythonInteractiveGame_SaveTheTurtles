...
public class LifeManager : MonoBehaviour
{
    ...
    private void InitializeHearts(int maxLives)
    {
        ...
        {
            heartsFull[i] = Instantiate(heartFullPrefab, heartsContainer.position + Vector3.right * i * 0.8f, rotation, heartsContainer);

            heartsEmpty[i] = Instantiate(heartEmptyPrefab, heartsContainer.position + Vector3.right * i * 0.8f, rotation, heartsContainer);
