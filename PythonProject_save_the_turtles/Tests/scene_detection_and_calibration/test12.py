...
def detect_color(image, lower, upper, color_name):
...
def auto_detect_edges(image_path):
    ...
    green_square = detect_color(hsv, lower_green, upper_green, "Green")
    blue_square = detect_color(hsv, lower_blue, upper_blue, "Blue")
...
while True:
    ...
    if ret:
        ...
        # Détection des carrés de couleur avec visualisation du masque
        green_square = detect_color(hsv, lower_green, upper_green, "Green")
        blue_square = detect_color(hsv, lower_blue, upper_blue, "Blue")
